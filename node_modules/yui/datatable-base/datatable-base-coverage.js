...
_yuitest_coverline("build/datatable-base/datatable-base.js", 219);
Y.DataTable.Base = Y.Base.create('datatable', Y.Widget, [Y.DataTable.Core], {
    ...
    **/
    delegate: function () {
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "delegate", 236);
_yuitest_coverline("build/datatable-base/datatable-base.js", 237);
var contentBox = this.get('contentBox');

        _yuitest_coverline("build/datatable-base/datatable-base.js", 239);
return contentBox.delegate.apply(contentBox, arguments);
    ...
    **/
    destructor: function () {
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "destructor", 249);
_yuitest_coverline("build/datatable-base/datatable-base.js", 250);
if (this.view) {
            _yuitest_coverline("build/datatable-base/datatable-base.js", 251);
this.view.destroy();
        }
    },
    ...
    **/
    getCell: function (/* seed, shift */) {
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "getCell", 284);
_yuitest_coverline("build/datatable-base/datatable-base.js", 285);
return this.view && this.view.getCell &&
    ...
    **/
    getRow: function (/* id */) {
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "getRow", 302);
_yuitest_coverline("build/datatable-base/datatable-base.js", 303);
return this.view && this.view.getRow &&
    ...
    **/
    ...
    _afterDisplayColumnsChange: function (e) {
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "_afterDisplayColumnsChange", 317);
_yuitest_coverline("build/datatable-base/datatable-base.js", 318);
this._extractDisplayColumns(e.newVal || []);
    ...
    **/
    bindUI: function () {
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "bindUI", 328);
_yuitest_coverline("build/datatable-base/datatable-base.js", 329);
this._eventHandles.relayCoreChanges = this.after(
    ...
    **/
    _defRenderViewFn: function (e) {
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "_defRenderViewFn", 346);
_yuitest_coverline("build/datatable-base/datatable-base.js", 347);
e.view.render();
    },
    ...
    **/
    ...
    _extractDisplayColumns: function (columns) {
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "_extractDisplayColumns", 360);
_yuitest_coverline("build/datatable-base/datatable-base.js", 361);
var displayColumns = [];

        _yuitest_coverline("build/datatable-base/datatable-base.js", 363);
function process(cols) {
            _yuitest_coverfunc("build/datatable-base/datatable-base.js", "process", 363);
_yuitest_coverline("build/datatable-base/datatable-base.js", 364);
var i, len, col;

            _yuitest_coverline("build/datatable-base/datatable-base.js", 366);
for (i = 0, len = cols.length; i < len; ++i) {
                _yuitest_coverline("build/datatable-base/datatable-base.js", 367);
col = cols[i];

                _yuitest_coverline("build/datatable-base/datatable-base.js", 369);
if (Y.Lang.isArray(col.children)) {
                    _yuitest_coverline("build/datatable-base/datatable-base.js", 370);
process(col.children);
                } else {
                    _yuitest_coverline("build/datatable-base/datatable-base.js", 372);
displayColumns.push(col);
                }
            }
        }

        _yuitest_coverline("build/datatable-base/datatable-base.js", 377);
process(columns);
        ...
        @since 3.5.0
        **/
        _yuitest_coverline("build/datatable-base/datatable-base.js", 387);
this._displayColumns = displayColumns;
    ...
    **/
    initializer: function () {
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "initializer", 398);
_yuitest_coverline("build/datatable-base/datatable-base.js", 399);
this.publish('renderView', {
        ...
        _yuitest_coverline("build/datatable-base/datatable-base.js", 405);
this._extractDisplayColumns(this.get('columns') || []);
        ...
        _yuitest_coverline("build/datatable-base/datatable-base.js", 410);
this.after('columnsChange', Y.bind('_afterDisplayColumnsChange', this));
    ...
    **/
    _relayCoreAttrChange: function (e) {
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "_relayCoreAttrChange", 421);
_yuitest_coverline("build/datatable-base/datatable-base.js", 422);
var attr = (e.attrName === 'data') ? 'modelList' : e.attrName;

        _yuitest_coverline("build/datatable-base/datatable-base.js", 424);
this.view.set(attr, e.newVal);
    ...
    **/
    renderUI: function () {
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "renderUI", 435);
_yuitest_coverline("build/datatable-base/datatable-base.js", 436);
var self = this,
            View = this.get('view');

        _yuitest_coverline("build/datatable-base/datatable-base.js", 439);
if (View) {
            _yuitest_coverline("build/datatable-base/datatable-base.js", 440);
this.view = new View(
                Y.merge(
                    this.getAttrs(),
                    {
...
if (!this._eventHandles.legacyFeatureProps) {
                _yuitest_coverline("build/datatable-base/datatable-base.js", 454);
this._eventHandles.legacyFeatureProps = this.view.after({
                    renderHeader: function (e) {
                        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "renderHeader", 455);
_yuitest_coverline("build/datatable-base/datatable-base.js", 456);
self.head = e.view;
                        _yuitest_coverline("build/datatable-base/datatable-base.js", 457);
self._theadNode = e.view.theadNode;
                        ...
                        _yuitest_coverline("build/datatable-base/datatable-base.js", 461);
self._tableNode = e.view.get('container');
                    },
                    renderFooter: function (e) {
                        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "renderFooter", 463);
...
self._tfootNode = e.view.tfootNode;
                        _yuitest_coverline("build/datatable-base/datatable-base.js", 466);
self._tableNode = e.view.get('container');
                    },
                    renderBody: function (e) {
                        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "renderBody", 468);
...
self._tbodyNode = e.view.tbodyNode;
                        _yuitest_coverline("build/datatable-base/datatable-base.js", 471);
self._tableNode = e.view.get('container');
                    },
                    // FIXME: guarantee that the properties are available, even
                    // if the configured (or omitted) views don't create them
                    renderTable: function () {
                        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "renderTable", 475);
_yuitest_coverline("build/datatable-base/datatable-base.js", 476);
var contentBox = this.get('container');

                        _yuitest_coverline("build/datatable-base/datatable-base.js", 478);
self._tableNode = this.tableNode ||
                        ...
                        _yuitest_coverline("build/datatable-base/datatable-base.js", 486);
self._captionNode = this.captionNode ||
                            contentBox.one('caption');

                        _yuitest_coverline("build/datatable-base/datatable-base.js", 489);
if (!self._theadNode) {
                            _yuitest_coverline("build/datatable-base/datatable-base.js", 490);
...
if (!self._tbodyNode) {
                            _yuitest_coverline("build/datatable-base/datatable-base.js", 495);
...
if (!self._tfootNode) {
                            _yuitest_coverline("build/datatable-base/datatable-base.js", 500);
self._tfootNode = contentBox.one(
            ...
            _yuitest_coverline("build/datatable-base/datatable-base.js", 510);
this.view.addTarget(this);
    ...
    **/
    syncUI: function () {
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "syncUI", 520);
_yuitest_coverline("build/datatable-base/datatable-base.js", 521);
if (this.view) {
            _yuitest_coverline("build/datatable-base/datatable-base.js", 522);
this.fire('renderView', { view: this.view });
    ...
    **/
    _validateView: function (val) {
        ...
        _yuitest_coverfunc("build/datatable-base/datatable-base.js", "_validateView", 534);
_yuitest_coverline("build/datatable-base/datatable-base.js", 536);
...
_yuitest_coverline("build/datatable-base/datatable-base.js", 679);
Y.DataTable = Y.mix(
