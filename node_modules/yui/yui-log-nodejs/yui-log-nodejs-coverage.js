...
t = t+''; //Force to a string..
    _yuitest_coverline("build/yui-log-nodejs/yui-log-nodejs.js", 54);
switch (t.toLowerCase()) {
        case 'error':
            _yuitest_coverline("build/yui-log-nodejs/yui-log-nodejs.js", 56);
lvl = mLvl = 31;
            _yuitest_coverline("build/yui-log-nodejs/yui-log-nodejs.js", 57);
break;
        case 'warn':
            _yuitest_coverline("build/yui-log-nodejs/yui-log-nodejs.js", 59);
lvl = 33;
            _yuitest_coverline("build/yui-log-nodejs/yui-log-nodejs.js", 60);
break;
        case 'debug':
            _yuitest_coverline("build/yui-log-nodejs/yui-log-nodejs.js", 62);
lvl = 34;
            _yuitest_coverline("build/yui-log-nodejs/yui-log-nodejs.js", 63);
break;
    }
...
if (str && str.indexOf("\n") !== -1) {
            _yuitest_coverline("build/yui-log-nodejs/yui-log-nodejs.js", 67);
str = "\n" + str;
        }
    }

    // output log messages to stderr
    _yuitest_coverline("build/yui-log-nodejs/yui-log-nodejs.js", 72);
