/* YUI 3.9.0pr3 (build 245) Copyright 2013 Yahoo! Inc. http://yuilibrary.com/license/ */
...
var YUI = function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "YUI", 59);
...
var i = 0,
            ...
            instanceOf = function(o, type) {
                _yuitest_coverfunc("build/yui-base/yui-base.js", "instanceOf", 64);
...
if (!(instanceOf(Y, YUI))) {
            _yuitest_coverline("build/yui-base/yui-base.js", 70);
Y = new YUI();
        } else {
            // set up the core environment
            _yuitest_coverline("build/yui-base/yui-base.js", 73);
Y._init();
...
if (YUI.GlobalConfig) {
                _yuitest_coverline("build/yui-base/yui-base.js", 101);
...
if (gconf) {
                _yuitest_coverline("build/yui-base/yui-base.js", 130);
Y.applyConfig(gconf);
            }
...
if (!l) {
                _yuitest_coverline("build/yui-base/yui-base.js", 135);
Y._setup();
            }
        }

        _yuitest_coverline("build/yui-base/yui-base.js", 139);
if (l) {
...
Y._setup();
        ...
        _yuitest_coverline("build/yui-base/yui-base.js", 151);
...
_yuitest_coverline("build/yui-base/yui-base.js", 156);
(function() {

    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 1)", 156);
_yuitest_coverline("build/yui-base/yui-base.js", 158);
var proto, prop,
        VERSION = '3.9.0pr3',
        PERIOD = '.',
        ...
        */
        ...
        add = function(el, type, fn, capture) {
            _yuitest_coverfunc("build/yui-base/yui-base.js", "add", 181);
_yuitest_coverline("build/yui-base/yui-base.js", 182);
if (el && el.addEventListener) {
                _yuitest_coverline("build/yui-base/yui-base.js", 183);
el.addEventListener(type, fn, capture);
            } else {_yuitest_coverline("build/yui-base/yui-base.js", 184);
if (el && el.attachEvent) {
                _yuitest_coverline("build/yui-base/yui-base.js", 185);
el.attachEvent('on' + type, fn);
            }}
        },
        remove = function(el, type, fn, capture) {
            _yuitest_coverfunc("build/yui-base/yui-base.js", "remove", 188);
...
el.removeEventListener(type, fn, capture);
            ...
            } else {_yuitest_coverline("build/yui-base/yui-base.js", 194);
if (el && el.detachEvent) {
                _yuitest_coverline("build/yui-base/yui-base.js", 195);
el.detachEvent('on' + type, fn);
            }}
        },
        handleLoad = function() {
            _yuitest_coverfunc("build/yui-base/yui-base.js", "handleLoad", 198);
...
if (hasWin) {
                _yuitest_coverline("build/yui-base/yui-base.js", 202);
remove(window, 'load', handleLoad);
            }
        },
        getLoader = function(Y, o) {
            _yuitest_coverfunc("build/yui-base/yui-base.js", "getLoader", 205);
_yuitest_coverline("build/yui-base/yui-base.js", 206);
...
if (mods && mods.loader) {
                _yuitest_coverline("build/yui-base/yui-base.js", 223);
lCore = [].concat(lCore, YUI.Env.loaderExtras);
            }
            _yuitest_coverline("build/yui-base/yui-base.js", 225);
YUI.Env.core = Y.Array.dedupe([].concat(YUI.Env.core, lCore));

            _yuitest_coverline("build/yui-base/yui-base.js", 227);
return loader;
        },

        clobber = function(r, s) {
            _yuitest_coverfunc("build/yui-base/yui-base.js", "clobber", 230);
_yuitest_coverline("build/yui-base/yui-base.js", 231);
for (var i in s) {
                _yuitest_coverline("build/yui-base/yui-base.js", 232);
if (s.hasOwnProperty(i)) {
                    _yuitest_coverline("build/yui-base/yui-base.js", 233);
r[i] = s[i];
                }
            }
        },
...
_yuitest_coverline("build/yui-base/yui-base.js", 254);
proto = {
    /**
    ...
    **/
    applyConfig: function(o) {
        ...
        _yuitest_coverfunc("build/yui-base/yui-base.js", "applyConfig", 264);
_yuitest_coverline("build/yui-base/yui-base.js", 266);
o = o || NOOP;

        _yuitest_coverline("build/yui-base/yui-base.js", 268);
var attr,
            name,
            // detail,
            config = this.config,
...
if (mods && name == 'modules') {
                    _yuitest_coverline("build/yui-base/yui-base.js", 281);
clobber(mods, attr);
                } else {_yuitest_coverline("build/yui-base/yui-base.js", 282);
if (aliases && name == 'aliases') {
                    _yuitest_coverline("build/yui-base/yui-base.js", 283);
clobber(aliases, attr);
                } else {_yuitest_coverline("build/yui-base/yui-base.js", 284);
...
config[name] = (attr && attr.contentWindow) || attr;
                    _yuitest_coverline("build/yui-base/yui-base.js", 288);
config.doc = config[name] ? config[name].document : null;
                } else {_yuitest_coverline("build/yui-base/yui-base.js", 289);
if (name == '_yuid') {
                    // preserve the guid
                } else {
                    _yuitest_coverline("build/yui-base/yui-base.js", 292);
config[name] = attr;
                }}}}}
            }
        }
...
if (loader) {
            _yuitest_coverline("build/yui-base/yui-base.js", 298);
loader._config(o);
        }
    ...
    **/
    _config: function(o) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "_config", 311);
_yuitest_coverline("build/yui-base/yui-base.js", 312);
this.applyConfig(o);
    },
    ...
    **/
    _init: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "_init", 321);
_yuitest_coverline("build/yui-base/yui-base.js", 322);
var filter, el,
            Y = this,
            G_ENV = YUI.Env,
            Env = Y.Env,
        ...
        **/
        _yuitest_coverline("build/yui-base/yui-base.js", 337);
Y.version = VERSION;

        _yuitest_coverline("build/yui-base/yui-base.js", 339);
if (!Env) {
            _yuitest_coverline("build/yui-base/yui-base.js", 340);
Y.Env = {
                ...
                parseBasePath: function(src, pattern) {
                    _yuitest_coverfunc("build/yui-base/yui-base.js", "parseBasePath", 385);
_yuitest_coverline("build/yui-base/yui-base.js", 386);
...
path = RegExp.leftContext || src.slice(0, src.indexOf(match[0]));
                        ...
                        _yuitest_coverline("build/yui-base/yui-base.js", 394);
filter = match[3];
...
path += '?' + match[1];
                        ...
                        _yuitest_coverline("build/yui-base/yui-base.js", 401);
path = {
                            filter: filter,
                            path: path
                        };
...
return path;
                ...
                getBase: G_ENV && G_ENV.getBase ||
                        function(pattern) {
                            _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 2)", 409);
...
Env = Y.Env;
            ...
            _yuitest_coverline("build/yui-base/yui-base.js", 434);
Env._loaded[VERSION] = {};
...
Env._yidx = ++G_ENV._yidx;
                _yuitest_coverline("build/yui-base/yui-base.js", 438);
Env._guidp = ('yui_' + VERSION + '_' +
                             Env._yidx + '_' + time).replace(/[^a-z0-9_]+/g, '_');
            } else {_yuitest_coverline("build/yui-base/yui-base.js", 440);
if (YUI._YUI) {
...
if (!(prop in Env)) {
                        _yuitest_coverline("build/yui-base/yui-base.js", 448);
Env[prop] = G_ENV[prop];
                    }
                }
...
Y.id = Y.stamp(Y);
            _yuitest_coverline("build/yui-base/yui-base.js", 456);
instances[Y.id] = Y;

        }

        _yuitest_coverline("build/yui-base/yui-base.js", 460);
Y.constructor = YUI;

        // configuration defaults
        _yuitest_coverline("build/yui-base/yui-base.js", 463);
Y.config = Y.config || {
            bootstrap: true,
            cacheUse: true,
            debug: true,
...
filter = (filter) ? '-' + filter : filter;
        _yuitest_coverline("build/yui-base/yui-base.js", 498);
Y.config.loaderPath = YUI.config.loaderPath || 'loader/loader' + filter + '.js';
    ...
    **/
    _setup: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "_setup", 509);
...
if (mods[extras[i]]) {
                _yuitest_coverline("build/yui-base/yui-base.js", 517);
core.push(extras[i]);
            }
        }
...
if (Y.Loader) {
            _yuitest_coverline("build/yui-base/yui-base.js", 525);
getLoader(Y);
        }
    ...
    **/
    applyTo: function(id, method, args) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "applyTo", 542);
...
return m && m.apply(instance, args);
        ...
        _yuitest_coverline("build/yui-base/yui-base.js", 561);
return null;
    },
...
**/
    add: function(name, fn, version, details) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "add", 611);
_yuitest_coverline("build/yui-base/yui-base.js", 612);
details = details || {};
        _yuitest_coverline("build/yui-base/yui-base.js", 613);
var env = YUI.Env,
            mod = {
                name: name,
                fn: fn,
...
if (!loader.moduleInfo[name] || loader.moduleInfo[name].temp) {
                            _yuitest_coverline("build/yui-base/yui-base.js", 637);
...
return this;
    ...
    **/
    _attach: function(r, moot) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "_attach", 657);
...
if (!Y._attach(after, true)) {
                                    _yuitest_coverline("build/yui-base/yui-base.js", 765);
return false;
                                }
                                _yuitest_coverline("build/yui-base/yui-base.js", 767);
break;
                            }
                        }
                    }
...
Y.error('Attach error: ' + name, e, name);
                                _yuitest_coverline("build/yui-base/yui-base.js", 780);
return false;
                            }
                        }
                    }
...
break;
        ...
        _yuitest_coverline("build/yui-base/yui-base.js", 802);
return true;
    },
    ...
    **/
    _delayCallback: function(cb, until) {
        ...
        _yuitest_coverfunc("build/yui-base/yui-base.js", "_delayCallback", 816);
...
return function() {
            _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 3)", 827);
_yuitest_coverline("build/yui-base/yui-base.js", 828);
var args = arguments;
            _yuitest_coverline("build/yui-base/yui-base.js", 829);
Y._use(mod, function() {
                _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 4)", 829);
_yuitest_coverline("build/yui-base/yui-base.js", 830);
Y.on(until.event, function() {
                    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 5)", 830);
_yuitest_coverline("build/yui-base/yui-base.js", 831);
args[1].delayUntil = until.event;
                    _yuitest_coverline("build/yui-base/yui-base.js", 832);
cb.apply(Y, args);
                }, until.args);
            });
        };
    ...
    **/
    use: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "use", 901);
_yuitest_coverline("build/yui-base/yui-base.js", 902);
...
exports.YUI = YUI;
        ...
        */
        _yuitest_coverline("build/yui-base/yui-base.js", 1490);
YUI.setLoadHook = function(fn) {
            _yuitest_coverfunc("build/yui-base/yui-base.js", "setLoadHook", 1490);
_yuitest_coverline("build/yui-base/yui-base.js", 1491);
YUI._getLoadHook = fn;
        };
        /**
        ...
        */
        _yuitest_coverline("build/yui-base/yui-base.js", 1500);
...
@since 3.6.0
**/
_yuitest_coverline("build/yui-base/yui-base.js", 1751);
...
_yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 8)", 1751);
_yuitest_coverline("build/yui-base/yui-base.js", 1773);
var L = Y.Lang || (Y.Lang = {}),
...
L._isNative = function (fn) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "_isNative", 1821);
 ...
 * @static
 */
_yuitest_coverline("build/yui-base/yui-base.js", 1839);
L.isArray = L._isNative(Array.isArray) ? Array.isArray : function (o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isArray", 1839);
_yuitest_coverline("build/yui-base/yui-base.js", 1840);
...
L.isBoolean = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isBoolean", 1850);
_yuitest_coverline("build/yui-base/yui-base.js", 1851);
...
L.isDate = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isDate", 1861);
_yuitest_coverline("build/yui-base/yui-base.js", 1862);
 ...
 */
_yuitest_coverline("build/yui-base/yui-base.js", 1889);
L.isFunction = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isFunction", 1889);
_yuitest_coverline("build/yui-base/yui-base.js", 1890);
...
L.isNull = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isNull", 1900);
_yuitest_coverline("build/yui-base/yui-base.js", 1901);
return o === null;
};
...
L.isNumber = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isNumber", 1911);
_yuitest_coverline("build/yui-base/yui-base.js", 1912);
...
L.isObject = function(o, failfn) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isObject", 1926);
_yuitest_coverline("build/yui-base/yui-base.js", 1927);
var t = typeof o;
 ...
 */
_yuitest_coverline("build/yui-base/yui-base.js", 1939);
L.isString = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isString", 1939);
_yuitest_coverline("build/yui-base/yui-base.js", 1940);
...
L.isUndefined = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isUndefined", 1950);
_yuitest_coverline("build/yui-base/yui-base.js", 1951);
...
L.isValue = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isValue", 1963);
_yuitest_coverline("build/yui-base/yui-base.js", 1964);
var t = L.type(o);

    _yuitest_coverline("build/yui-base/yui-base.js", 1966);
switch (t) {
        case 'number':
            _yuitest_coverline("build/yui-base/yui-base.js", 1968);
return isFinite(o);
 ...
 * @since 3.3.0
 */
_yuitest_coverline("build/yui-base/yui-base.js", 1987);
L.now = Date.now || function () {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 9)", 1987);
_yuitest_coverline("build/yui-base/yui-base.js", 1988);
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui-base/yui-base.js", 2002);
L.sub = function(s, o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "sub", 2002);
_yuitest_coverline("build/yui-base/yui-base.js", 2003);
return s.replace ? s.replace(SUBREGEX, function (match, key) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 10)", 2003);
 ...
 */
_yuitest_coverline("build/yui-base/yui-base.js", 2016);
L.trim = STRING_PROTO.trim ? function(s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 11)", 2016);
_yuitest_coverline("build/yui-base/yui-base.js", 2017);
return s && s.trim ? s.trim() : s;
} : function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2018);
_yuitest_coverline("build/yui-base/yui-base.js", 2019);
try {
        _yuitest_coverline("build/yui-base/yui-base.js", 2020);
return s.replace(TRIMREGEX, '');
    } catch (e) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2022);
return s;
    }
};
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui-base/yui-base.js", 2033);
L.trimLeft = STRING_PROTO.trimLeft ? function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 12)", 2033);
_yuitest_coverline("build/yui-base/yui-base.js", 2034);
return s.trimLeft();
} : function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2035);
_yuitest_coverline("build/yui-base/yui-base.js", 2036);
return s.replace(/^\s+/, '');
};
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui-base/yui-base.js", 2046);
L.trimRight = STRING_PROTO.trimRight ? function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 13)", 2046);
_yuitest_coverline("build/yui-base/yui-base.js", 2047);
return s.trimRight();
} : function (s) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2048);
...
L.type = function(o) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "type", 2079);
...
function YArray(thing, startIndex, force) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "YArray", 2120);
...
for (len = thing.length; startIndex < len; ++startIndex) {
                _yuitest_coverline("build/yui-base/yui-base.js", 2134);
...
return result;
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 2141);
return [thing];
}

_yuitest_coverline("build/yui-base/yui-base.js", 2144);
Y.Array = YArray;
...
YArray.dedupe = function (array) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "dedupe", 2160);
...
for (i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2166);
item = array[i];

        _yuitest_coverline("build/yui-base/yui-base.js", 2168);
if (!hasOwn.call(hash, item)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2169);
hash[item] = 1;
            _yuitest_coverline("build/yui-base/yui-base.js", 2170);
results.push(item);
        }
    }
...
YArray.hash = function (keys, values) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "hash", 2229);
_yuitest_coverline("build/yui-base/yui-base.js", 2230);
var hash = {},
...
if (i in keys) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2236);
hash[keys[i]] = vlen > i && i in values ? values[i] : true;
        }
    }

    _yuitest_coverline("build/yui-base/yui-base.js", 2240);
return hash;
};
...
@static
**/
_yuitest_coverline("build/yui-base/yui-base.js", 2257);
YArray.indexOf = Lang._isNative(Native.indexOf) ? function (array, value, from) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 15)", 2257);
_yuitest_coverline("build/yui-base/yui-base.js", 2258);
return Native.indexOf.call(array, value, from);
} : function (array, value, from) {
    // http://es5.github.com/#x15.4.4.14
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2259);
_yuitest_coverline("build/yui-base/yui-base.js", 2261);
var len = array.length;

    _yuitest_coverline("build/yui-base/yui-base.js", 2263);
from = +from || 0;
    _yuitest_coverline("build/yui-base/yui-base.js", 2264);
from = (from > 0 || -1) * Math.floor(Math.abs(from));

    _yuitest_coverline("build/yui-base/yui-base.js", 2266);
if (from < 0) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2267);
from += len;

        _yuitest_coverline("build/yui-base/yui-base.js", 2269);
if (from < 0) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2270);
from = 0;
        }
    }

    _yuitest_coverline("build/yui-base/yui-base.js", 2274);
for (; from < len; ++from) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2275);
if (from in array && array[from] === value) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2276);
return from;
        }
    }
...
@static
**/
_yuitest_coverline("build/yui-base/yui-base.js", 2302);
YArray.numericSort = function (a, b) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "numericSort", 2302);
_yuitest_coverline("build/yui-base/yui-base.js", 2303);
return a - b;
};
...
YArray.some = Lang._isNative(Native.some) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 16)", 2322);
_yuitest_coverline("build/yui-base/yui-base.js", 2323);
return Native.some.call(array, fn, thisObj);
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "}", 2324);
...
YArray.test = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "test", 2352);
_yuitest_coverline("build/yui-base/yui-base.js", 2353);
var result = 0;

    _yuitest_coverline("build/yui-base/yui-base.js", 2355);
if (Lang.isArray(obj)) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2356);
result = 1;
    } else {_yuitest_coverline("build/yui-base/yui-base.js", 2357);
...
try {
            ...
            _yuitest_coverline("build/yui-base/yui-base.js", 2362);
 ...
 */
_yuitest_coverline("build/yui-base/yui-base.js", 2386);
function Queue() {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "Queue", 2386);
_yuitest_coverline("build/yui-base/yui-base.js", 2387);
this._init();
    _yuitest_coverline("build/yui-base/yui-base.js", 2388);
...
Queue.prototype = {
    ...
    _init: function() {
         ...
         * @protected
         */
        _yuitest_coverfunc("build/yui-base/yui-base.js", "_init", 2398);
...
this._q = [];
     ...
     */
    next: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "next", 2415);
_yuitest_coverline("build/yui-base/yui-base.js", 2416);
return this._q.shift();
     ...
     */
    last: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "last", 2425);
_yuitest_coverline("build/yui-base/yui-base.js", 2426);
return this._q.pop();
    },
     ...
     */
    add: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "add", 2436);
_yuitest_coverline("build/yui-base/yui-base.js", 2437);
this._q.push.apply(this._q, arguments);

        _yuitest_coverline("build/yui-base/yui-base.js", 2439);
return this;
    },
     ...
     */
    size: function() {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "size", 2448);
_yuitest_coverline("build/yui-base/yui-base.js", 2449);
...
@for YUI
**/
_yuitest_coverline("build/yui-base/yui-base.js", 2495);
Y.cached = function (source, cache, refetch) {
    /*jshint expr: true*/
    _yuitest_coverfunc("build/yui-base/yui-base.js", "cached", 2495);
_yuitest_coverline("build/yui-base/yui-base.js", 2497);
cache || (cache = {});

    _yuitest_coverline("build/yui-base/yui-base.js", 2499);
return function (arg) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 17)", 2499);
...
var key = arguments.length > 1 ?
        ...
        /*jshint eqeqeq: false*/
        _yuitest_coverline("build/yui-base/yui-base.js", 2505);
if (!(key in cache) || (refetch && cache[key] == refetch)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2506);
...
Y.getLocation = function () {
    ...
    _yuitest_coverfunc("build/yui-base/yui-base.js", "getLocation", 2529);
...
Y.merge = function () {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "merge", 2554);
_yuitest_coverline("build/yui-base/yui-base.js", 2555);
var i      = 0,
...
for (; i < len; ++i) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2562);
obj = arguments[i];
...
**/
_yuitest_coverline("build/yui-base/yui-base.js", 2608);
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "mix", 2608);
_yuitest_coverline("build/yui-base/yui-base.js", 2609);
...
if (!receiver || !supplier) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2615);
return receiver || Y;
    }
...
if (mode === 2) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2623);
Y.mix(receiver.prototype, supplier.prototype, overwrite,
        ...
        _yuitest_coverline("build/yui-base/yui-base.js", 2629);
...
if (!from || !to) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2636);
return receiver;
        }
    } else {
        _yuitest_coverline("build/yui-base/yui-base.js", 2639);
from = supplier;
        _yuitest_coverline("build/yui-base/yui-base.js", 2640);
to   = receiver;
    }
...
for (i = 0, len = whitelist.length; i < len; ++i) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2649);
key = whitelist[i];
...
if (merge && exists && isObject(to[key], true)
                ...
                _yuitest_coverline("build/yui-base/yui-base.js", 2675);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-base/yui-base.js", 2676);
if (overwrite || !exists) {
                // We're not in merge mode, so we'll only copy the `from` value
                // to the `to` value if we're in overwrite mode or if the
                // current key doesn't exist on the `to` object.
                _yuitest_coverline("build/yui-base/yui-base.js", 2680);
to[key] = from[key];
            }}
        }
    } else {
        _yuitest_coverline("build/yui-base/yui-base.js", 2684);
for (key in from) {
            ...
            _yuitest_coverline("build/yui-base/yui-base.js", 2690);
if (!hasOwn.call(from, key)) {
                _yuitest_coverline("build/yui-base/yui-base.js", 2691);
continue;
            }
...
exists = alwaysOverwrite ? false : key in to;
            ...
            _yuitest_coverline("build/yui-base/yui-base.js", 2699);
if (merge && exists && isObject(to[key], true)
                    && isObject(from[key], true)) {
                _yuitest_coverline("build/yui-base/yui-base.js", 2701);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-base/yui-base.js", 2702);
if (overwrite || !exists) {
...
_yuitest_coverline("build/yui-base/yui-base.js", 2731);
var Lang   = Y.Lang,
    hasOwn = Object.prototype.hasOwnProperty,
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 18)", 2747);
_yuitest_coverline("build/yui-base/yui-base.js", 2753);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 19)", 2754);
_yuitest_coverline("build/yui-base/yui-base.js", 2756);
function F() {}

    // The actual shim.
    _yuitest_coverline("build/yui-base/yui-base.js", 2759);
return function (obj) {
        _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 20)", 2759);
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "owns", 2822);
 ...
 * @static
 */
_yuitest_coverline("build/yui-base/yui-base.js", 2858);
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "keys", 2858);
_yuitest_coverline("build/yui-base/yui-base.js", 2859);
if (!Lang.isObject(obj)) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2860);
...
for (i = 0, len = forceEnum.length; i < len; ++i) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2882);
key = forceEnum[i];

            _yuitest_coverline("build/yui-base/yui-base.js", 2884);
if (owns(obj, key)) {
                _yuitest_coverline("build/yui-base/yui-base.js", 2885);
keys.push(key);
            }
        }
    }
 ...
 * @static
 */
_yuitest_coverline("build/yui-base/yui-base.js", 2910);
O.values = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "values", 2910);
...
O.size = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "size", 2931);
...
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "hasValue", 2949);
...
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "each", 2973);
_yuitest_coverline("build/yui-base/yui-base.js", 2974);
var key;

    _yuitest_coverline("build/yui-base/yui-base.js", 2976);
for (key in obj) {
        _yuitest_coverline("build/yui-base/yui-base.js", 2977);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 2978);
fn.call(thisObj || Y, obj[key], key, obj);
        }
    }

    _yuitest_coverline("build/yui-base/yui-base.js", 2982);
return Y;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui-base/yui-base.js", 3005);
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "some", 3005);
_yuitest_coverline("build/yui-base/yui-base.js", 3006);
var key;

    _yuitest_coverline("build/yui-base/yui-base.js", 3008);
for (key in obj) {
        _yuitest_coverline("build/yui-base/yui-base.js", 3009);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3010);
if (fn.call(thisObj || Y, obj[key], key, obj)) {
                _yuitest_coverline("build/yui-base/yui-base.js", 3011);
return true;
            }
        }
    }

    _yuitest_coverline("build/yui-base/yui-base.js", 3016);
return false;
};
 ...
 */
_yuitest_coverline("build/yui-base/yui-base.js", 3032);
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "getValue", 3032);
_yuitest_coverline("build/yui-base/yui-base.js", 3033);
if (!Lang.isObject(o)) {
        _yuitest_coverline("build/yui-base/yui-base.js", 3034);
return UNDEFINED;
    }
...
for (i = 0; o !== UNDEFINED && i < l; i++) {
        _yuitest_coverline("build/yui-base/yui-base.js", 3042);
o = o[p[i]];
    }

    _yuitest_coverline("build/yui-base/yui-base.js", 3045);
return o;
};
...
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "setValue", 3062);
...
var i,
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 3068);
if (leafIdx >= 0) {
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui-base/yui-base.js", 3092);
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "isEmpty", 3092);
_yuitest_coverline("build/yui-base/yui-base.js", 3093);
...
YUI.Env.parseUA = function(subUA) {
    ...
    _yuitest_coverfunc("build/yui-base/yui-base.js", "parseUA", 3128);
_yuitest_coverline("build/yui-base/yui-base.js", 3130);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui-base/yui-base.js", "numberify", 3130);
_yuitest_coverline("build/yui-base/yui-base.js", 3131);
var c = 0;
            _yuitest_coverline("build/yui-base/yui-base.js", 3132);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui-base/yui-base.js", "(anonymous 22)", 3132);
_yuitest_coverline("build/yui-base/yui-base.js", 3133);
return (c++ === 1) ? '' : '.';
            }));
        },
...
o.os = 'windows';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3376);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3377);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3378);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3379);
o.os = 'android';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3380);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3381);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3382);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui-base/yui-base.js", 3383);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui-base/yui-base.js", 3384);
if ((/rhino/i).test(ua)) {
...
o.safari = o.webkit;
            ...
            _yuitest_coverline("build/yui-base/yui-base.js", 3404);
...
m = numberify(m[1].replace('_', '.'));
                ...
                _yuitest_coverline("build/yui-base/yui-base.js", 3419);
o.ios = m;
...
o.mobile = m[0];
                ...
                _yuitest_coverline("build/yui-base/yui-base.js", 3433);
if (/webOS/.test(ua)) {
                    _yuitest_coverline("build/yui-base/yui-base.js", 3434);
o.mobile = 'WebOS';
                    _yuitest_coverline("build/yui-base/yui-base.js", 3435);
m = ua.match(/webOS\/([^\s]*);/);
                    _yuitest_coverline("build/yui-base/yui-base.js", 3436);
if (m && m[1]) {
...
o.silk = numberify(m[1]);
                    ...
                    _yuitest_coverline("build/yui-base/yui-base.js", 3455);
if (!o.android) {
...
o.mobile = 'chrome';
                ...
                _yuitest_coverline("build/yui-base/yui-base.js", 3473);
m = ua.match(/AdobeAIR\/([^\s]*)/);
                _yuitest_coverline("build/yui-base/yui-base.js", 3474);
if (m) {
                    _yuitest_coverline("build/yui-base/yui-base.js", 3475);
...
if (/Opera/.test(ua)) {
                _yuitest_coverline("build/yui-base/yui-base.js", 3483);
m = ua.match(/Opera[\s\/]([^\s]*)/);
                _yuitest_coverline("build/yui-base/yui-base.js", 3484);
if (m && m[1]) {
                    _yuitest_coverline("build/yui-base/yui-base.js", 3485);
o.opera = numberify(m[1]);
                }
                _yuitest_coverline("build/yui-base/yui-base.js", 3487);
m = ua.match(/Version\/([^\s]*)/);
                _yuitest_coverline("build/yui-base/yui-base.js", 3488);
if (m && m[1]) {
                    _yuitest_coverline("build/yui-base/yui-base.js", 3489);
...
o.mobile = 'opera';
                    _yuitest_coverline("build/yui-base/yui-base.js", 3494);
m = ua.replace('Opera Mobi', '').match(/Opera ([^\s]*)/);
                    _yuitest_coverline("build/yui-base/yui-base.js", 3495);
if (m && m[1]) {
                        _yuitest_coverline("build/yui-base/yui-base.js", 3496);
o.opera = numberify(m[1]);
                    }
                }
...
if (m) {
                    _yuitest_coverline("build/yui-base/yui-base.js", 3502);
o.mobile = m[0]; // ex: Opera Mini/2.0.4509/1316
                }
            } else { // not opera or webkit
                _yuitest_coverline("build/yui-base/yui-base.js", 3505);
m = ua.match(/MSIE\s([^;]*)/);
                _yuitest_coverline("build/yui-base/yui-base.js", 3506);
if (m && m[1]) {
                    _yuitest_coverline("build/yui-base/yui-base.js", 3507);
o.ie = numberify(m[1]);
                } else { // not opera, webkit, or ie
                    _yuitest_coverline("build/yui-base/yui-base.js", 3509);
m = ua.match(/Gecko\/([^\s]*)/);
                    _yuitest_coverline("build/yui-base/yui-base.js", 3510);
if (m) {
                        _yuitest_coverline("build/yui-base/yui-base.js", 3511);
o.gecko = 1; // Gecko detected, look for revision
                        _yuitest_coverline("build/yui-base/yui-base.js", 3512);
m = ua.match(/rv:([^\s\)]*)/);
                        _yuitest_coverline("build/yui-base/yui-base.js", 3513);
if (m && m[1]) {
                            _yuitest_coverline("build/yui-base/yui-base.js", 3514);
o.gecko = numberify(m[1]);
    ...
    _yuitest_coverline("build/yui-base/yui-base.js", 3524);
...
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui-base/yui-base.js", "compareVersions", 3570);
